...
description: AFFINE 是一款集成了 Notion 和 Miro 功能的开源知识库工具，本文详细介绍如何通过 Sealos 一键部署私有 AFFINE，保护数据安全的同时享受全部高级功能。
tags: [Notes, Sealos, Wiki]
keywords: [AFFINE, Sealos, Notion, Notes, Wiki, whiteboard, 知识库管理, 开源笔记, Notion替代品, 私有化部署, 协作工具, 在线白板]
date: 2024-04-07
image: /images/how-to-set-up-affine.png
authors:
  - yangchuansheng
---
...
![AFFINE 在 Sealos 平台的部署配置界面](./images/AFFINE-on-sealos.png)
*图 4：Sealos 平台上的 AFFINE 部署配置页面*

等待实例的状态变成 running 后，点击日志图标查看日志：

![AFFINE 部署日志查看界面](./images/AFFINE-on-sealos2.png)
...
![AFFINE 实例详情页面](./images/AFFINE-details.png)
*图 7：AFFINE 实例详情页面*
...
![AFFINE 云服务启用界面](./images/AFFINE-console.png)
*图 8：AFFINE 云服务启用页面*
...
![AFFINE 文档模式](./images/AFFINE-text-mode.png)
*图 9：AFFINE 文档模式*
...
![AFFINE 白板模式](./images/AFFINE-whiteboard-mode.jpg)
*图 11：AFFINE 白板模式*

AFFINE 内置了丰富的模板库，包括脑图、任务计划、项目管理、市场图标分析等多种类型，您可以一键导入这些模板快速开始工作。

![AFFINE 白板模式模板](./images/AFFINE-whiteboard-mode-template.webp)
*图 12：AFFINE 白板模式模板*
